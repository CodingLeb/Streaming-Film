...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2023 at 08:17 AM
...
(44, 1, 'Berhasil mengubah profile', 1684583681),
(45, 1, 'Berhasil mengubah password', 1684583739),
(46, 1, 'Berhasil mengubah profile', 1685422106),
(47, 1, 'Berhasil mengubah password', 1685422134),
(48, 1, 'Berhasil mengubah profile', 1685511268),
(49, 1, 'Berhasil mengubah password', 1685511280),
(50, 1, 'Berhasil mengubah profile', 1685511298),
(51, 1, 'Berhasil mengubah password', 1685511312),
(52, 1, 'Berhasil mengubah profile', 1685511473),
(53, 1, 'Berhasil mengubah password', 1685511480),
(54, 1, 'Berhasil mengubah profile', 1685945744);
...
(2, 'admin', '$2y$10$O5AYjc67xNEENEaFE0HjFOvHXSXHmSC4LnwD6vaUc5HnfBnz2C1fy', 'admin', '5eccfb7172310.jpg');
...
--
ALTER TABLE `tb_riwayat`
  MODIFY `id_riwayat` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
